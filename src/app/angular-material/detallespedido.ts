...
@Component({
    ...
    <mat-card style="width:100%; height:100%">
     ...
     <virtual-scroller #scroll_productosMostrar [items]="data" style="width: 100%; height:100%">
          ...
          <tbody>
          <tr  *ngFor="let _producto of scroll_productosMostrar.viewPortItems">
     ...
     <strong>total_general:</strong><b>$</b> <span style="font-weight:bold;font-size:1rem">{{total_venta_general.toLocaleString("de-DE")}}</span>
